...
public:
    ...
    double findMedianSortedArrays(vector<int>& nums1, vector<int>& nums2) {
        ...
        if (end1 != end2 && m > min(end1, end2)) { // TODO: Hier kann auch m - 1 > min(end1, end2) sein müssen!! Wenn %2 etc.
            ...
            if (end1 > end2) {
                return getMedianFromPartialVector(nums1, l); // TODO: Offset
            }
            else {
                return getMedianFromPartialVector(nums2, l); // TODO: Offset
            }
        }
        ...
        return getMedianFromPartialVector(mv, l); // TODO: Offset
